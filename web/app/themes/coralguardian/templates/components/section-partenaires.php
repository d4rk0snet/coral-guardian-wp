...
?>
<section id="section-<?php echo $flexible_count; ?>" class="cg-section-partner cg-section section-<?php echo $bgcolor ?>">
	<div class="container">
			...
			?>
				<div class="bloc-partner">
					<a href="<?php echo $website ?>" target="_blank">
						<img class="partner-pic lazy" src="#" data-src="<?php echo $pic["url"]; ?>" alt="<?php echo $pic["alt"]; ?>"/>
